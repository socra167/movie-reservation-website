  ...
  <body>
    <div class="movie-div">
      <div class="searchbar-filter-div">
        ...
        <div class="div57">
          <input class="icon" alt="" id="node" />
          <div class="iconactionsearch-24px-div1">
            <img class="color-icon9" alt="" src="./web_project/public/-color7.svg" />
          </div>
        </div>
      </div>
      <div class="header-div3">
        <img class="tgv-logo-icon3" alt="" src="./web_project/public/tgv-logo@2x.png" />
        <div class="div58">
          <b class="tgv-b3">TGV</b>
          <div class="tu-golden-village3">TU Golden Village</div>
        </div>
        <div class="div59"><div class="logout-div3">Logout</div></div>
      </div>
      <div class="movies-div">
        ...
        <div class="first-item-div">
          <div class="movie-1-div">
            ...
            <div class="div61">84% 예매율 34.4%</div>
          </div>
